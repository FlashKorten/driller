...
CREATE INDEX dr_scenario_year_from_group_idx ON dr_scenario(year_from_group ASC);
ALTER INDEX dr_scenario_year_from_group_idx OWNER TO driller;
CREATE INDEX dr_scenario_year_upto_group_idx ON dr_scenario(year_upto_group ASC);
